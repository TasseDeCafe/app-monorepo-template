...
## How to get project keys

all the keys should be loaded with doppler, but if you want to set them up from scratch, read the below:
...
go to https://supabase.com/dashboard/project/krtllimmygzciwxngbmd/settings/api and https://supabase.com/dashboard/project/krtllimmygzciwxngbmd/settings/auth

to make sign in redirects go to: https://supabase.com/dashboard/project/krtllimmygzciwxngbmd/auth/url-configuration
and fill the values like: ![](docs/images/supabase-redirect-urls.png)

## Deployment

Probably the most difficult step, as it requires a lot of setup, and since it's a one time thing, it's very easy to forget how to do it.
refer to docs at: https://www.notion.so/grammarians/How-to-create-a-droplet-and-make-it-our-production-instance-9c0cf0744a3745db985a712e203af87f
