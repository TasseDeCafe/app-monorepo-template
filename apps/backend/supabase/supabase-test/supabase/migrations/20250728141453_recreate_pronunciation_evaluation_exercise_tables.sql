DROP TABLE IF EXISTS public.pronunciation_evaluation_attempts CASCADE;
DROP TABLE IF EXISTS public.pronunciation_evaluation_exercises CASCADE;
...
CREATE TABLE public.pronunciation_evaluation_attempts (
    ...
    user_parsed_input TEXT NOT NULL,
...
CREATE INDEX idx_pronunciation_exercises_user_dialect ON public.pronunciation_evaluation_exercises(user_id, dialect, created_at DESC);
