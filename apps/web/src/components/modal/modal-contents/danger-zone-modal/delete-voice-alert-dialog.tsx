...
export const DeleteVoiceAlertDialog = () => {
  ...
  const handleDeleteRequest = async () => {
    deleteMutation.mutate({ type: 'voice' })
  }
      ...
      <AlertDialogContent className='max-w-sm rounded-lg bg-white p-6 shadow-xl md:max-w-md'>
        <AlertDialogHeader className='gap-y-2'>
          ...
          <AlertDialogDescription className='text-sm text-gray-500'>
            {t`This action cannot be undone. This will permanently delete your voice and related data from our servers. After deleting your voice you will be redirected to recreate your voice.`}
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
